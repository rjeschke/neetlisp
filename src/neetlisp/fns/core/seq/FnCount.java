...
public class FnCount extends Fn
{
    public FnCount(final Context context)
    {
        super(context, new FnMeta("core/count", "A doc string", 1, false, 0));
    }
    
    public Object eval(Object seq)
    {
        return NumInt.create(((NFiniteSeq)seq).size());
    }
