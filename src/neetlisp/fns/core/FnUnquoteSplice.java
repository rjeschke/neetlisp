...
public class FnUnquoteSplice extends Fn
{
    public FnUnquoteSplice(final Context context)
    {
        super(context, new FnMeta("core/unquote-splice", 
                "(xs)\n" +
                " Unquotes and splices xs, only accessible in syntax-quote", 
                1, false, FnMeta.FLAG_SPECIAL_FORM));
    }
