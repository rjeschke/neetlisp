...
public class SpecialCoreAdd implements SpecializedCompile
{
    @Override
    public Name getName()
    {
    ...
    {
        NumInt.create(0).compile(cfn, mv);
        for (NIterator it = cdr.getIterator(); it.hasNext(); )
        {
            ...
            mv.visitMethodInsn(Opcodes.INVOKEINTERFACE, "neetlisp/Number", "add", "(Lneetlisp/Number;)Lneetlisp/Number;");
        }
    }
}
